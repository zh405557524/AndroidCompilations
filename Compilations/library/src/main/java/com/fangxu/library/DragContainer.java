...
public class DragContainer extends ViewGroup {
    ...
    private void setContentView(int left, int top, int right, int bottom) {
        ...
        Log.i(TAG, "left: " + left + " top:" + top + " right:" + right + " bottom" + bottom+"  containerWidth:"+containerWidth);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dragDx <= 0 && dragChecker.canDrag(contentView)) {
                    ...
                    float realDragDistanceY = dragDy * dragDamp;
                    setContentView((int) realDragDistance, (int) realDragDistanceY,
                            containerWidth + (int) realDragDistance, (int) (containerHeight+realDragDistanceY));
                }
                break;
