...
/**
 * Description: canvas案例，欢迎页面
 * Author: 祝明
 * CreateDate: 2019/4/21 下午2:16
 * UpdateUser:
 * UpdateDate: 2019/4/21 下午2:16
 * UpdateRemark:
 */
public class SplashView extends View {
    ...
    private void init(Context context) {
        ...
        mCirceColors = context.getResources().getIntArray(R.array.splash_circle_colors);
    ...
    private void drawCircles(Canvas canvas) {
        float rotateAngle = (float) (Math.PI * 2 / mCirceColors.length);
        for (int i = 0; i < mCirceColors.length; i++) {
            //x = r *cos(a)+centX
            //y = r*sin(a)+centY
            ...
            mPaint.setColor(mCirceColors[i]);
