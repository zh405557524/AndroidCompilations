...
import com.soul.multimediademo.service.IMusicService;
import com.soul.multimediademo.service.MusicService;
...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infos.add(new MusicInfo("爱你", "http://192.168.0.106:8080/aini.mp3"));
        infos.add(new MusicInfo("千年泪", "http://192.168.0.106:8080/qnl.mp3"));
